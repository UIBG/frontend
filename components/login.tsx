...
const LoginComponent = () => {
    return (
        <div className="bg-white shadow-md rounded-xl max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-zinc-900">
            <form className="space-y-6" action="#">
                ...
                <div className="flex items-center justify-between">
                    <Link href="#" className="text-sm text-blue-700 hover:underline dark:text-blue-500">
                ...
                <div className="space-y-3">
                    <button
                        type="submit"
                        className="w-full text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                ...
                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                    Not registered?{' '}
                    <Link href="/auth/register" className="text-blue-700 hover:underline dark:text-blue-500">
                        Create account
                    </Link>
                </div>
            </form>
